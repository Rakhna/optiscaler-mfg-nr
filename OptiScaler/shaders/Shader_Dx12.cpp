...
{
    return CreateComputeShader(device, _rootSignature, pipelineState, nullptr,
                                           ...
                                           D3D12_CPU_DESCRIPTOR_HANDLE srvDescriptor, DXGI_FORMAT format)
{
    ...
    default:
        LOG_ERROR("ERROR: CreateShaderResourceView cannot be used with DIMENSION_UNKNOWN or BUFFER.");
                                            ...
                                            D3D12_CPU_DESCRIPTOR_HANDLE uavDescriptor, uint32_t mipLevel)
{
    ...
    case D3D12_RESOURCE_DIMENSION_UNKNOWN:
    default:
        LOG_ERROR("ERROR: CreateUnorderedResourceView cannot be used with DIMENSION_UNKNOWN or BUFFER.");
        throw std::invalid_argument("unknown resource dimension");
    }
                                         ...
                                         D3D12_CPU_DESCRIPTOR_HANDLE rtvDescriptor, uint32_t mipLevel)
{
    ...
    case D3D12_RESOURCE_DIMENSION_UNKNOWN:
    default:
        LOG_ERROR("ERROR: CreateRenderTargetView cannot be used with DIMENSION_UNKNOWN or BUFFER.");
        throw std::invalid_argument("unknown resource dimension");
    }
